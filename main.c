...
#define DEFAULT_CLIENT_ID "286d9740208f"//"123456789"
#define SERVER_ADDR "192.168.0.2"//"10.0.1.98"	// need to be changed with correct server address
#define RED "RED"
#define BLUE "BLUE"
#define GREEN "GREEN"
#define RED_LED 45
...
int main(int argc, char *argv[]) {
    ...
    while(1) {
    	//printf("why are you here??? get out of here\n");
    }
}
